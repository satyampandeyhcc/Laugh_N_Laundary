      ...
      <div className="benifits">
        ...
        <div className="frame-div">
          <div className="group-parent">
            <div className="pexels-amina-filkins-5414061-1-parent">
              <img
            ...
            <div className="affordable-per-kilo-price-parent">
              <div className="affordable-per-kilo-container">
                <p className="every-spin">{`Affordable `}</p>
                <p className="every-spin">per Kilo price</p>
              </div>
              <img
                className="pexels-amina-filkins-5414061-1-icon"
                alt=""
            ...
            <div className="satisfaction-guaranteed-parent">
              ...
              <img
                className="pexels-amina-filkins-5414061-1-icon"
                alt=""
                src="/younggirlstandingironingboardwithclotheslivingroom-2@2x.png"
              />
            ...
            <div className="green-certified-detergent-parent">
              <div className="affordable-per-kilo-container">
              ...
              <img
                className="pexels-amina-filkins-5414061-1-icon"
                alt=""
                src="/colorfultowelsliquidlaundrydetergent-1@2x.png"
              />
              <div className="component-31">
                <div className="component-1-item" />
        ...
        <b className="why-laugh-n">Why Laugh N Laundry?</b>
      </div>
        ...
        <div className="cards">
          ...
          <div className="rectangle-parent">
            ...
            <div className="step-1-parent">
              ...
              <div className="pickup">{`Wash & Dry`}</div>
            </div>
          </div>
          <div className="rectangle-parent">
            <div className="group-item" />
      ...
      <div className="services1">
        ...
        <div className="cards1">
          <div className="cardbase-parent">
            ...
            <div className="cardbase4">
              <img
                className="lady-putting-laundry-washing-m-icon"
                alt=""
                src="/gh060622howtowashaweightedblanket1654536744-1@2x.png"
              />
              <b className="wash">Blanket Cleaning</b>
            </div>
            <div className="cardbase5">
              <img
                className="lady-putting-laundry-washing-m-icon"
                alt=""
                src="/concentratedshoemakerworkshopmakingshoes-1@2x.png"
              />
              <b className="wash">Shoe Cleaning</b>
            </div>
          </div>
        </div>
        <div className="experience-savings-pickup">
        ...
        <div className="lorem-ipsum-parent">
          ...
          <div className="lorem-ipsum-dolor-container">
            <p className="lorem-ipsum-dolor">
              ...
              consequat quam lacus, at ultricies eros mattis ac. Duis nunc
              augue, molestie aliquet hendrerit id, mollis a tortor. Aenean vel
              nibh quam. In dolor diam, molestie eu ultricies non, rhoncus sed
              turpis. Suspendisse in malesuada massa. Proin pretium lacus eget
              vehicula bibendum. Pellentesque hendrerit facilisis libero, vel
              sodales tortor tristique eget. In consectetur eu libero in
              rhoncus. Ut id sagittis dolor.
            </p>
            <p className="every-spin">{`Integer tempus nisi convallis tincidunt ornare. Nullam maximus `}</p>
          </div>
        </div>
      </div>
      <div className="project-inner">
        <div className="shirt-service-10-rs-parent">
          <div className="shirt-service-10">{`     Shirt Service 10 Rs     |      `}</div>
          <div className="shirt-service-101">{`     Shirt Service 10 Rs     |      `}</div>
          <div className="shirt-service-102">{`     Shirt Service 10 Rs     |      `}</div>
        </div>
      </div>
    </div>
  );
